...
entity tb_qnn_cell_radial_guard_filter_v2 is
end entity;

architecture sim of tb_qnn_cell_radial_guard_filter_v2 is
...
begin
    ...
    dut : entity work.qnn_cell_radial_guard_filter_v2
        port map (
            clk => clk,
            reset_n => reset_n,
    ...
    begin
        ...
        report "qnn_cell_radial_guard_filter_v2 simulation PASS" severity note;
        stop;
        wait;
    end process;
