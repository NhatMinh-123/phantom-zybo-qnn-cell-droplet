...
entity microplastic_patch_qnn_uart_top is
    port (
...
end entity microplastic_patch_qnn_uart_top;

architecture rtl of microplastic_patch_qnn_uart_top is
    ...
    signal sum_output_data  : std_logic_vector(31 downto 0);
    signal sum_output_valid : std_logic;
    signal sum_output_ready : std_logic;
begin
    ...
    bridge_inst : entity work.finn_uart_bridge
        ...
        port map (
            ...
            m_axis_tdata  => sum_output_data,
            m_axis_tvalid => sum_output_valid,
            m_axis_tready => sum_output_ready,
            status_led    => led
        );

    reducer_inst : entity work.axis_int24_sum16
        port map (
            clk           => clk100,
