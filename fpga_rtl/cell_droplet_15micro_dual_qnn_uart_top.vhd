...
-- One FINN QNN core.  The host submits two adjacent ROIs as two UART frames;
-- both inferences therefore execute in the FPGA without duplicating the core.
entity cell_droplet_15micro_dual_qnn_uart_top is
    port (
...
end entity cell_droplet_15micro_dual_qnn_uart_top;

architecture rtl of cell_droplet_15micro_dual_qnn_uart_top is
