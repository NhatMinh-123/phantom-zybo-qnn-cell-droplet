"""Warm-started event-gated QNN entry point for stable PC timing."""
...
if __name__ == "__main__":
    ...
    print(
        f"Warm event-gated QNN: {application.CHECKPOINT_PATH}; "
    ...
    if output is not None:
        ...
        payload["pipeline"] = "one_droplet_event_gated_qnn_warm_w4a6_v1"
