...
entity cell_droplet_15micro_qnn96_roi120_dual_guard_uart_sparse_stream_top is
    port (
...
end entity cell_droplet_15micro_qnn96_roi120_dual_guard_uart_sparse_stream_top;

architecture rtl of
    cell_droplet_15micro_qnn96_roi120_dual_guard_uart_sparse_stream_top is
    ...
    signal requant_output_data  : std_logic_vector(7 downto 0);
    signal requant_output_valid : std_logic;
    signal requant_output_ready : std_logic;
    signal guarded_output_data  : std_logic_vector(7 downto 0);
    signal guarded_output_valid : std_logic;
    signal guarded_output_ready : std_logic;
begin
    ...
    bridge_inst : entity work.finn_uart_sparse_stream_bridge
        ...
        port map (
            ...
            m_axis_tdata  => guarded_output_data,
            m_axis_tvalid => guarded_output_valid,
            m_axis_tready => guarded_output_ready,
            status_led    => led
        );
    ...
    requantizer_inst : entity work.detector_output_requantizer_15micro
        port map (
            ...
            m_axis_tdata  => requant_output_data,
            m_axis_tvalid => requant_output_valid,
            m_axis_tready => requant_output_ready
        );

    radial_guard_inst : entity work.qnn_cell_radial_guard_filter
        generic map (
            IMAGE_WIDTH           => 96,
            IMAGE_HEIGHT          => 96,
            GRID_WIDTH            => 24,
        ...
        port map (
            ...
            s_axis_tdata   => requant_output_data,
            s_axis_tvalid  => requant_output_valid,
            s_axis_tready  => requant_output_ready,
            m_axis_tdata   => guarded_output_data,
            m_axis_tvalid  => guarded_output_valid,
            m_axis_tready  => guarded_output_ready
        );
